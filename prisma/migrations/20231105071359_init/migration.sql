...
CREATE TABLE "SuketTidakMampu" (
    ...
    CONSTRAINT "SuketTidakMampu_pkey" PRIMARY KEY ("no_surat")
);
...
-- AddForeignKey
ALTER TABLE "SuketTidakMampu" ADD CONSTRAINT "SuketTidakMampu_pendudukId_fkey" FOREIGN KEY ("pendudukId") REFERENCES "Penduduk"("nik") ON DELETE RESTRICT ON UPDATE CASCADE;
